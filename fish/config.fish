...
alias lsl="eza --color=always --git --icons=always -l"
alias wasi-clang /opt/wasi-sdk/bin/clang
fish_add_path -g ~/Munka/lwnode/out/linux/Release/
fish_add_path -g /usr/lib/emsdk/upstream/emscripten/
fish_add_path -g ~/hexegg/target/release/
fish_add_path -g ~/helix/target/release/
